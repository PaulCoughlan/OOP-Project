 ...
 * @author alexander
 */
public class EarthNote extends javax.swing.JPanel {
    private String EarthNote;
    
    private EarthNote qArray[];
    
    private int count;

    /**
     * Creates new form EarthNote
     */
    public EarthNote() {
        initComponents();
        EarthNote = new String();
        
        qArray = new EarthNote[6];
        count = 0;
    }
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        // TODO add your handling code here:
         EarthNote = EarthNote.getText();
        
        //create a new Question object
        EarthNote e = new EarthNote();
        
        //add contents of textfields to q
        e.setEarthNote(EarthNote);
    ...
    private void DisplayAllActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_DisplayAllActionPerformed
        ...
        for(int i = 0; i < qArray.length;i++){
            JOptionPane.showMessageDialog(null, "Note "+qArray[i].getEarthNote());
        }
